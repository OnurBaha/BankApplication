...
{
    public const string TaxNumberExists = "A company with this Tax Number already exists.";
    public const string CompanyRegistrationNumberExists = "A company with this Registration Number already exists.";
